  ...
  useEffect(() => {
    ...
    function drawBossSprite(mon, mx, my, t) {
      ...
      // ── 2. 라이추 (Raichu) ──
        ...
        const [O1,O2,O3,DA,C] = ['#FFC870','#FF8C00','#C05A00','#3D2000','#FAEBD7'];
        p(0,1,DA);p(1,1,O3);p(7,1,O3);p(8,1,DA);           // round ear dark edge
        p(0,2,O3);p(1,2,O2);p(2,2,O2);p(6,2,O2);p(7,2,O2);p(8,2,O3);
        p(1,3,O1);p(2,3,O1);p(3,3,O1);p(4,3,O1);p(5,3,O1);p(6,3,O1);p(7,3,O1);
        p(0,4,O2);p(1,4,B);p(2,4,O1);p(3,4,O2);p(4,4,O2);p(5,4,O1);p(6,4,B);p(7,4,O2);
        p(3,4,DA);p(4,4,DA);                                // nose
        p(0,5,C);p(1,5,C);p(2,5,O2);p(3,5,O2);p(4,5,O2);p(5,5,O2);p(6,5,C);p(7,5,C); // cream cheeks
        p(0,6,O2);p(1,6,O1);p(2,6,C);p(3,6,C);p(4,6,C);p(5,6,C);p(6,6,O1);p(7,6,O2); // belly
        p(0,7,O3);p(1,7,O2);p(2,7,O2);p(3,7,O2);p(4,7,O2);p(5,7,O2);p(6,7,O2);p(7,7,O3);
        p(1,8,O2);p(2,8,O3);p(5,8,O3);p(6,8,O2);
        // curly tail right
        p(8,4,DA);p(9,4,O2);p(9,5,O3);p(8,5,O2);p(9,6,O3);p(8,6,DA);p(9,7,O2);p(8,7,O3);

      // ── 3. 파이리 (Charmander) ──
      } else if (n === "파이리") {
        const [O1,O2,O3,C,FL,FY] = ['#FF9868','#FF5530','#C03018','#FFDDB0','#FF2200','#FFD700'];
        p(2,1,O1);p(3,1,O1);p(4,1,O1);p(5,1,O1);
        p(1,2,O2);p(2,2,O1);p(3,2,O1);p(4,2,O1);p(5,2,O1);p(6,2,O2);
        p(0,3,O2);p(1,3,B);p(2,3,O1);p(3,3,O2);p(4,3,O2);p(5,3,O1);p(6,3,B);p(7,3,O2);
        p(3,3,DA);p(4,3,DA);                                // nose (overwrite)
        p(0,4,O2);p(1,4,O1);p(2,4,C);p(3,4,C);p(4,4,C);p(5,4,C);p(6,4,O1);p(7,4,O2);
        p(1,5,O3);p(2,5,C);p(3,5,C);p(4,5,C);p(5,5,C);p(6,5,O3);
        p(1,6,O2);p(2,6,C);p(3,6,C);p(4,6,C);p(5,6,C);p(6,6,O2);
        p(2,7,O2);p(3,7,O3);p(4,7,O3);p(5,7,O2);
        p(1,8,O2);p(2,8,O3);p(5,8,O3);p(6,8,O2);
        p(2,9,C);p(3,9,C);p(5,9,C);p(6,9,C);              // feet cream
        // tail with flame
        p(7,5,O2);p(7,6,O2);p(7,7,O3);p(8,7,FL);p(8,6,FY);p(8,5,FL);p(9,6,FY);p(9,5,FL);

      // ── 4. 꼬부기 (Squirtle) ──
      } else if (n === "꼬부기") {
        const [L1,L2,L3,SH,GR] = ['#90C8FF','#5B8DD9','#3A68B8','#9B7A45','#4A7A30'];
        p(2,1,L1);p(3,1,L1);p(4,1,L1);p(5,1,L1);
        p(1,2,L2);p(2,2,L1);p(3,2,L1);p(4,2,L1);p(5,2,L1);p(6,2,L2);
        p(0,3,L2);p(1,3,B);p(2,3,L1);p(3,3,L2);p(4,3,L2);p(5,3,L1);p(6,3,B);p(7,3,L2);
        p(0,4,L2);p(1,4,L1);p(2,4,W);p(3,4,L1);p(4,4,L1);p(5,4,W);p(6,4,L1);p(7,4,L2);
        p(3,4,B);p(5,4,B);                                  // pupils
        p(3,5,B);p(4,5,B);                                  // mouth
        // shell body
        p(0,5,SH);p(1,5,SH);p(2,5,SH);p(3,5,SH);p(4,5,SH);p(5,5,SH);p(6,5,SH);p(7,5,SH);
        p(0,6,SH);p(1,6,GR);p(2,6,SH);p(3,6,GR);p(4,6,GR);p(5,6,SH);p(6,6,GR);p(7,6,SH);
        p(0,7,SH);p(1,7,SH);p(2,7,GR);p(3,7,SH);p(4,7,SH);p(5,7,GR);p(6,7,SH);p(7,7,SH);
        p(1,8,L2);p(2,8,L3);p(5,8,L3);p(6,8,L2);
        // curly tail left
        p(-1,6,L2);p(-1,7,L3);p(-2,7,L2);

      // ── 5. 거북왕 (Blastoise) ──
      } else if (n === "거북왕") {
        const [L1,L2,L3,SH,CA] = ['#70A8D8','#2C7BB6','#1A5898','#8B6914','#708090'];
        const GR='#3A7A30';
        p(2,1,L1);p(3,1,L1);p(4,1,L1);p(5,1,L1);
        p(1,2,L2);p(2,2,L1);p(3,2,L2);p(4,2,L2);p(5,2,L1);p(6,2,L2);
        p(0,3,L2);p(1,3,B);p(2,3,L1);p(3,3,L2);p(4,3,L2);p(5,3,L1);p(6,3,B);p(7,3,L2);
        // cannons (very distinctive)
        p(-2,3,CA);p(-1,3,CA);p(-2,4,CA);p(-1,4,CA);p(-2,5,CA);p(-1,5,CA);
        p(8,3,CA);p(9,3,CA);p(8,4,CA);p(9,4,CA);p(8,5,CA);p(9,5,CA);
        p(0,4,L2);p(1,4,L1);p(2,4,L2);p(3,4,L2);p(4,4,L2);p(5,4,L2);p(6,4,L1);p(7,4,L2);
        p(0,5,SH);p(1,5,SH);p(2,5,SH);p(3,5,SH);p(4,5,SH);p(5,5,SH);p(6,5,SH);p(7,5,SH);
        p(0,6,SH);p(1,6,GR);p(2,6,SH);p(3,6,GR);p(4,6,GR);p(5,6,SH);p(6,6,GR);p(7,6,SH);
        p(0,7,SH);p(1,7,SH);p(2,7,GR);p(3,7,SH);p(4,7,SH);p(5,7,GR);p(6,7,SH);p(7,7,SH);
        p(1,8,L2);p(2,8,L3);p(5,8,L3);p(6,8,L2);
      ...
      // ── 6. 팬텀 (Gengar) ──
        ...
        const [P1,P2,P3,R] = ['#9B6BC0','#7B4DA0','#5A2E80','#FF2020'];
        p(2,0,P2);p(3,0,P1);p(4,0,P1);p(5,0,P2);
        p(1,1,P2);p(2,1,P1);p(3,1,P1);p(4,1,P1);p(5,1,P1);p(6,1,P2);
        p(0,2,P2);p(1,2,P1);p(2,2,P1);p(3,2,P1);p(4,2,P1);p(5,2,P1);p(6,2,P1);p(7,2,P2);
        // wide red eyes
        p(0,3,R);p(1,3,R);p(2,3,R);p(3,3,P2);p(4,3,P2);p(5,3,R);p(6,3,R);p(7,3,R);
        p(1,4,B);p(2,4,P2);p(3,4,P2);p(4,4,P2);p(5,4,P2);p(6,4,B);
        p(0,5,P2);p(1,5,P1);p(2,5,P1);p(3,5,P1);p(4,5,P1);p(5,5,P1);p(6,5,P1);p(7,5,P2);
        // wide toothy grin
        p(1,6,P2);p(2,6,W);p(3,6,B);p(4,6,B);p(5,6,W);p(6,6,P2);
        p(2,6,W);p(3,6,B);p(4,6,B);p(5,6,W);
        // jagged bottom
        p(0,7,P2);p(1,7,B);p(2,7,P2);p(3,7,B);p(4,7,P2);p(5,7,B);p(6,7,P2);p(7,7,B);
        // floating hands
        p(-1,3,P2);p(-1,4,P3);p(8,3,P2);p(8,4,P3);

      // ── 7. 이상해씨 (Bulbasaur) ──
      } else if (n === "이상해씨") {
        const [G1,G2,G3,SP,DA,RD] = ['#88D8B0','#6CC5A0','#4A9870','#7EC850','#2E5A3A','#E05050'];
        // bulb on back
        p(3,0,SP);p(4,0,SP);p(5,0,SP);
        p(2,1,DA);p(3,1,RD);p(4,1,SP);p(5,1,RD);p(6,1,DA);
        p(2,2,SP);p(3,2,G2);p(4,2,SP);p(5,2,G2);p(6,2,SP);
        // body
        p(1,3,G2);p(2,3,G1);p(3,3,G1);p(4,3,G1);p(5,3,G1);p(6,3,G1);p(7,3,G2);
        p(0,4,G2);p(1,4,B);p(2,4,G1);p(3,4,G2);p(4,4,G2);p(5,4,G1);p(6,4,B);p(7,4,G2);
        p(3,4,DA);p(4,4,DA);                               // nose
        p(0,5,G2);p(1,5,G1);p(2,5,G1);p(3,5,G1);p(4,5,G1);p(5,5,G1);p(6,5,G1);p(7,5,G2);
        // spot pattern
        p(1,4,DA);p(6,4,DA);p(1,5,DA);p(6,5,DA);
        p(0,6,G3);p(1,6,G2);p(2,6,G2);p(3,6,G2);p(4,6,G2);p(5,6,G2);p(6,6,G2);p(7,6,G3);
        p(1,7,G3);p(2,7,DA);p(3,7,G3);p(4,7,G3);p(5,7,DA);p(6,7,G3);
        p(1,8,G2);p(2,8,G3);p(5,8,G3);p(6,8,G2);

      // ── 8. 리자몽 (Charizard) ──
      } else if (n === "리자몽") {
        const [O1,O2,O3,BL,FY,FR] = ['#FF9868','#FF5722','#C03010','#26C6DA','#FDD835','#FF1744'];
        // blue wings
        p(-2,2,BL);p(-1,2,BL);p(-1,3,BL);p(-2,3,BL);p(-1,4,BL);
        p(9,2,BL);p(8,2,BL);p(8,3,BL);p(9,3,BL);p(8,4,BL);
        // head + horn
        p(5,0,O3);                                         // horn
        p(2,1,O1);p(3,1,O1);p(4,1,O1);p(5,1,O1);
        p(1,2,O2);p(2,2,O1);p(3,2,O1);p(4,2,O1);p(5,2,O1);p(6,2,O2);
        p(0,3,O2);p(1,3,B);p(2,3,O1);p(3,3,O2);p(4,3,O2);p(5,3,O1);p(6,3,B);p(7,3,O2);
        p(3,3,DA);p(4,3,DA);                               // nose
        // blue belly
        p(0,4,O2);p(1,4,O1);p(2,4,BL);p(3,4,BL);p(4,4,BL);p(5,4,BL);p(6,4,O1);p(7,4,O2);
        p(1,5,O2);p(2,5,BL);p(3,5,BL);p(4,5,BL);p(5,5,BL);p(6,5,O2);
        p(1,6,O2);p(2,6,O1);p(3,6,O2);p(4,6,O2);p(5,6,O1);p(6,6,O2);
        p(2,7,O2);p(3,7,O3);p(4,7,O3);p(5,7,O2);
        p(1,8,O2);p(2,8,O3);p(5,8,O3);p(6,8,O2);
        // flame tail
        p(7,5,O2);p(7,6,O2);p(7,7,O3);p(8,7,FR);p(8,6,FY);p(9,6,FR);p(9,5,FY);

      // ── 9. 잠만보 (Snorlax) ──
      } else if (n === "잠만보") {
        const [T1,T2,T3,C] = ['#6A9C8E','#4A7C6F','#2E5043','#F5DEB3'];
        p(1,0,T2);p(2,0,T1);p(3,0,T1);p(5,0,T1);p(6,0,T1);p(7,0,T2); // ears
        p(0,1,T2);p(1,1,T1);p(2,1,T1);p(3,1,T1);p(4,1,T1);p(5,1,T1);p(6,1,T1);p(7,1,T2);
        p(0,2,T2);p(1,2,B);p(2,2,T1);p(3,2,T1);p(4,2,T1);p(5,2,T1);p(6,2,B);p(7,2,T2); // closed eyes
        p(0,3,T2);p(1,3,C);p(2,3,C);p(3,3,C);p(4,3,C);p(5,3,C);p(6,3,C);p(7,3,T2); // belly
        p(-1,4,T2);p(0,4,T2);p(1,4,C);p(2,4,C);p(3,4,C);p(4,4,C);p(5,4,C);p(6,4,C);p(7,4,T2);p(8,4,T2);
        p(-1,5,T2);p(0,5,T3);p(1,5,C);p(2,5,C);p(3,5,C);p(4,5,C);p(5,5,C);p(6,5,C);p(7,5,T3);p(8,5,T2);
        p(0,6,T2);p(1,6,C);p(2,6,C);p(3,6,C);p(4,6,C);p(5,6,C);p(6,6,C);p(7,6,T2);
        p(0,7,T2);p(1,7,T3);p(2,7,T2);p(3,7,T2);p(4,7,T2);p(5,7,T2);p(6,7,T3);p(7,7,T2);
        p(-1,3,T2);p(-1,4,T3);p(8,3,T2);p(8,4,T3);       // arms
        p(1,8,T2);p(2,8,T3);p(5,8,T3);p(6,8,T2);         // legs
        p(9,1,T3);p(9,2,T2);p(8,1,T3);                   // Zzz

      // ── 10. 메타몽 (Ditto) ──
      } else if (n === "메타몽") {
        const [P1,P2,P3] = ['#D0A0E0','#9B59B6','#6B2F8A'];
        p(2,0,P1);p(3,0,P1);p(4,0,P1);p(5,0,P1);
        p(1,1,P2);p(2,1,P1);p(3,1,P1);p(4,1,P1);p(5,1,P1);p(6,1,P2);
        p(0,2,P2);p(1,2,P1);p(2,2,P1);p(3,2,P1);p(4,2,P1);p(5,2,P1);p(6,2,P1);p(7,2,P2);
        p(0,3,P2);p(1,3,P1);p(2,3,P1);p(3,3,P1);p(4,3,P1);p(5,3,P1);p(6,3,P1);p(7,3,P2);
        p(2,4,B);p(5,4,B);                                 // dot eyes
        p(0,4,P2);p(1,4,P1);p(6,4,P1);p(7,4,P2);
        p(2,5,B);p(3,5,P3);p(4,5,P3);p(5,5,B);            // wavy mouth
        p(0,5,P2);p(1,5,P1);p(6,5,P1);p(7,5,P2);
        p(1,6,P2);p(2,6,P1);p(3,6,P1);p(4,6,P1);p(5,6,P1);p(6,6,P2);
        p(2,7,P2);p(3,7,P3);p(4,7,P3);p(5,7,P2);
        p(2,1,P1);p(1,2,P1);                               // highlight

      // ── 11. 이브이 (Eevee) ──
      } else if (n === "이브이") {
        const [B1,B2,B3,C,DA] = ['#D4A060','#A06030','#6A3A10','#FFF8E0','#3A1800'];
        p(1,0,DA);p(2,0,B2);p(6,0,B2);p(7,0,DA);          // pointed ears, dark edge
        p(1,1,B3);p(2,1,B1);p(3,1,B3);p(5,1,B3);p(6,1,B1);p(7,1,B3);
        p(2,2,B2);p(3,2,B3);p(5,2,B3);p(6,2,B2);
        p(2,3,B1);p(3,3,B1);p(4,3,B1);p(5,3,B1);
        p(1,4,B2);p(2,4,B1);p(3,4,B2);p(4,4,B2);p(5,4,B1);p(6,4,B2);
        p(2,4,DA);p(6,4,DA);                               // eyes
        p(0,5,B2);p(1,5,B1);p(2,5,C);p(3,5,B2);p(4,5,B2);p(5,5,C);p(6,5,B1);p(7,5,B2);
        // fluffy cream collar
        p(0,6,C);p(1,6,C);p(2,6,C);p(3,6,B1);p(4,6,B1);p(5,6,C);p(6,6,C);p(7,6,C);
        p(0,7,C);p(1,7,C);p(2,7,B2);p(3,7,B2);p(4,7,B2);p(5,7,B2);p(6,7,C);p(7,7,C);
        p(1,8,B2);p(2,8,B3);p(5,8,B3);p(6,8,B2);
        // bushy tail (right side)
        p(8,4,B2);p(9,4,C);p(9,5,C);p(8,5,B2);p(9,6,C);p(8,6,B3);p(9,7,C);p(8,7,B2);

      // ── 12. 뮤츠 (Mewtwo) ──
      } else if (n === "뮤츠") {
        const [G1,G2,G3,PU,T] = ['#D0C0E0','#A090C0','#7060A0','#4040B8','#C080FF'];
        p(3,0,T);p(4,0,T);                                 // Y-tube forehead
        p(1,1,G2);p(2,1,G1);p(3,1,G1);p(4,1,G1);p(5,1,G1);p(6,1,G2); // large head
        p(0,2,G2);p(1,2,G1);p(2,2,G1);p(3,2,G1);p(4,2,G1);p(5,2,G1);p(6,2,G1);p(7,2,G2);
        p(0,3,G2);p(1,3,G1);p(2,3,G1);p(3,3,G1);p(4,3,G1);p(5,3,G1);p(6,3,G1);p(7,3,G2);
        p(1,4,G2);p(2,4,PU);p(3,4,G2);p(4,4,G2);p(5,4,PU);p(6,4,G2); // eyes (purple)
        p(2,5,G2);p(3,5,G1);p(4,5,G1);p(5,5,G2);
        p(1,6,G3);p(2,6,G2);p(3,6,G2);p(4,6,G2);p(5,6,G2);p(6,6,G3);
        p(2,7,G3);p(3,7,G3);p(4,7,G3);p(5,7,G3);
        p(-1,5,G2);p(-1,6,G3);p(8,5,G2);p(8,6,G3);       // arms
        // long tail (right)
        p(7,5,G2);p(8,7,T);p(8,8,T);p(9,6,T);p(9,7,T);p(7,6,G2);

      // ── 13. 뮤 (Mew) ──
      } else if (n === "뮤") {
        const [P1,P2,P3] = ['#FFD8E8','#FF90C0','#D05890'];
        p(2,1,P2);p(3,1,P1);p(4,1,P1);p(5,1,P2);
        p(1,2,P2);p(2,2,P1);p(3,2,P1);p(4,2,P1);p(5,2,P1);p(6,2,P2);
        p(0,3,P2);p(1,3,P1);p(2,3,P1);p(3,3,P1);p(4,3,P1);p(5,3,P1);p(6,3,P1);p(7,3,P2);
        p(1,4,P2);p(2,4,B);p(3,4,P1);p(4,4,P1);p(5,4,P1);p(6,4,B);p(7,4,P2); // eyes
        p(2,4,W);p(6,4,W);                                 // eye highlight
        p(3,5,P3);p(4,5,P3);                               // small mouth
        p(0,5,P2);p(1,5,P1);p(2,5,P1);p(3,5,P1);p(4,5,P1);p(5,5,P1);p(6,5,P1);p(7,5,P2);
        p(1,6,P2);p(2,6,P1);p(3,6,P1);p(4,6,P1);p(5,6,P1);p(6,6,P2);
        p(2,7,P2);p(3,7,P2);p(4,7,P2);p(5,7,P2);
        p(1,2,P3);p(7,2,P3);                               // small round ears
        // long tail wrapping right
        p(7,5,P2);p(8,6,P3);p(9,5,P2);p(9,6,P3);p(9,7,P2);p(8,7,P3);p(8,8,P2);

      // ── 14. 푸린 (Jigglypuff) ──
      } else if (n === "푸린") {
        const [P1,P2,P3,EY] = ['#FFB8C8','#FF82A0','#C05070','#6090FF'];
        p(4,0,P3);p(3,0,P2);                               // curl
        p(2,1,P2);p(3,1,P1);p(4,1,P1);p(5,1,P1);p(6,1,P2);
        p(1,2,P2);p(2,2,P1);p(3,2,EY);p(4,2,EY);p(5,2,EY);p(6,2,EY);p(7,2,P2); // big blue eyes top
        p(0,3,P2);p(1,3,P1);p(2,3,EY);p(3,3,EY);p(4,3,EY);p(5,3,EY);p(6,3,P1);p(7,3,P2);
        p(2,3,B);p(5,3,B);                                 // pupils
        p(2,3,W);p(5,3,W);                                 // eye highlights
        p(3,4,B);p(4,4,B);                                 // small mouth
        p(0,4,P2);p(1,4,P1);p(2,4,P1);p(3,4,P1);p(4,4,P1);p(5,4,P1);p(6,4,P1);p(7,4,P2);
        p(0,5,P2);p(1,5,P1);p(2,5,P1);p(3,5,P1);p(4,5,P1);p(5,5,P1);p(6,5,P1);p(7,5,P2);
        p(1,6,P2);p(2,6,P1);p(3,6,P1);p(4,6,P1);p(5,6,P1);p(6,6,P2);
        p(2,7,P2);p(3,7,P2);p(4,7,P2);p(5,7,P2);
        p(-1,4,P2);p(-1,5,P3);p(8,4,P2);p(8,5,P3);       // tiny arms

      // ── 15. 망나뇽 (Dragonite) ──
      } else if (n === "망나뇽") {
        const [O1,O2,O3,T,W2] = ['#FFD880','#F0A830','#B07020','#60C8E0','#F8F0E0'];
        p(3,0,B);p(5,0,B);                                 // antenna
        p(3,1,O2);p(5,1,O2);
        p(2,2,O1);p(3,2,O1);p(4,2,O1);p(5,2,O1);p(6,2,O1);
        p(1,3,O2);p(2,3,O1);p(3,3,B);p(4,3,O2);p(5,3,B);p(6,3,O1);p(7,3,O2); // head+eyes
        p(3,4,DA);p(4,4,DA);                               // nose
        p(0,4,O2);p(1,4,O1);p(2,4,T);p(3,4,T);p(4,4,T);p(5,4,T);p(6,4,O1);p(7,4,O2); // teal belly
        p(0,5,O2);p(1,5,T);p(2,5,T);p(3,5,T);p(4,5,T);p(5,5,T);p(6,5,T);p(7,5,O2);
        // small wings
        p(-2,3,O1);p(-1,3,O2);p(-2,4,O1);p(-1,4,O2);
        p(9,3,O1);p(8,3,O2);p(9,4,O1);p(8,4,O2);
        p(1,6,O2);p(2,6,O1);p(3,6,T);p(4,6,T);p(5,6,O1);p(6,6,O2);
        p(1,7,O3);p(2,7,O2);p(3,7,O3);p(4,7,O3);p(5,7,O2);p(6,7,O3);
        p(1,8,O2);p(2,8,O3);p(5,8,O3);p(6,8,O2);
        p(7,6,O2);p(7,7,O3);p(8,7,O2);                    // small tail

      // ── 16. 이상해꽃 (Venusaur) ──
      } else if (n === "이상해꽃") {
        const [G1,G2,G3,FL,FK,PI] = ['#80C090','#5A9070','#386050','#E040B8','#FF80D0','#FF4090'];
        // big flower on top
        p(1,0,FL);p(2,0,FL);p(3,0,FK);p(4,0,FK);p(5,0,FL);p(6,0,FL);
        p(0,1,PI);p(1,1,FK);p(2,1,FK);p(3,1,G3);p(4,1,G3);p(5,1,FK);p(6,1,FK);p(7,1,PI);
        p(2,2,G2);p(3,2,G1);p(4,2,G1);p(5,2,G2);
        // wide green body
        p(0,3,G2);p(1,3,G1);p(2,3,G1);p(3,3,G1);p(4,3,G1);p(5,3,G1);p(6,3,G1);p(7,3,G2);
        p(0,4,G3);p(1,4,B);p(2,4,G1);p(3,4,G2);p(4,4,G2);p(5,4,G1);p(6,4,B);p(7,4,G3);
        p(3,4,DA);p(4,4,DA);
        p(0,5,G2);p(1,5,G1);p(2,5,G2);p(3,5,G2);p(4,5,G2);p(5,5,G2);p(6,5,G1);p(7,5,G2);
        p(0,6,G3);p(1,6,G2);p(2,6,G2);p(3,6,G2);p(4,6,G2);p(5,6,G2);p(6,6,G2);p(7,6,G3);
        p(1,7,G3);p(2,7,G3);p(5,7,G3);p(6,7,G3);
        p(1,8,G2);p(2,8,G3);p(5,8,G3);p(6,8,G2);

      // ── 17. 후딘 (Alakazam) ──
      } else if (n === "후딘") {
        const [Y1,Y2,Y3,BR,RD] = ['#FFF090','#D0B040','#A07820','#8B4513','#CC3030'];
        p(3,0,Y2);p(4,0,Y1);p(5,0,Y2);                    // head bump
        p(2,1,Y2);p(3,1,Y1);p(4,1,Y1);p(5,1,Y1);p(6,1,Y2);
        p(1,2,Y2);p(2,2,Y1);p(3,2,Y1);p(4,2,Y1);p(5,2,Y1);p(6,2,Y1);p(7,2,Y2);
        p(2,3,B);p(3,3,Y2);p(4,3,Y2);p(5,3,B);            // narrow eyes
        // mustache
        p(1,4,BR);p(2,4,BR);p(3,4,Y2);p(4,4,Y2);p(5,4,BR);p(6,4,BR);
        p(3,5,Y2);p(4,5,Y1);p(5,5,Y2);
        p(2,6,Y3);p(3,6,Y2);p(4,6,Y2);p(5,6,Y3);
        p(3,7,Y3);p(4,7,Y3);
        p(2,8,Y3);p(3,8,Y3);p(4,8,Y3);p(5,8,Y3);
        // spoons on sides
        p(-2,3,Y2);p(-1,3,Y3);p(-2,4,Y3);p(-1,4,Y2);
        p(9,3,Y2);p(8,3,Y3);p(9,4,Y3);p(8,4,Y2);
        p(1,5,Y2);p(1,6,Y3);p(7,5,Y2);p(7,6,Y3);         // arms

      // ── 18. 찌리리공 (Electrode) ──
      } else if (n === "찌리리공") {
        const [WH,RD,Y3] = ['#F8F8F8','#E83030','#FFD700'];
        // round white top half
        p(2,0,WH);p(3,0,WH);p(4,0,WH);p(5,0,WH);
        p(1,1,WH);p(2,1,WH);p(3,1,WH);p(4,1,WH);p(5,1,WH);p(6,1,WH);
        p(0,2,WH);p(1,2,WH);p(2,2,WH);p(3,2,WH);p(4,2,WH);p(5,2,WH);p(6,2,WH);p(7,2,WH);
        p(0,3,WH);p(1,3,WH);p(2,3,WH);p(3,3,WH);p(4,3,WH);p(5,3,WH);p(6,3,WH);p(7,3,WH);
        // lightning face
        p(2,2,Y3);p(3,2,Y3);p(4,2,Y3);p(5,3,Y3);p(4,3,Y3);p(5,4,Y3);p(6,4,Y3);
        p(2,3,B);p(6,3,B);                                 // angry eyes (brow)
        p(2,4,B);p(3,4,B);                                 // pupils
        p(6,3,B);p(7,3,B);
        // black divider line
        p(0,4,B);p(1,4,B);p(2,4,B);p(3,4,B);p(4,4,B);p(5,4,B);p(6,4,B);p(7,4,B);
        // round red bottom half
        p(0,5,RD);p(1,5,RD);p(2,5,RD);p(3,5,RD);p(4,5,RD);p(5,5,RD);p(6,5,RD);p(7,5,RD);
        p(0,6,RD);p(1,6,RD);p(2,6,RD);p(3,6,RD);p(4,6,RD);p(5,6,RD);p(6,6,RD);p(7,6,RD);
        p(1,7,RD);p(2,7,RD);p(3,7,RD);p(4,7,RD);p(5,7,RD);p(6,7,RD);
        p(2,8,RD);p(3,8,RD);p(4,8,RD);p(5,8,RD);

      // ── 19. 식스테일 (Vulpix) ──
      } else if (n === "식스테일") {
        const [O1,O2,O3,RD,C] = ['#FFC880','#E87030','#A04820','#C82020','#FFF0D0'];
        p(1,0,O3);p(2,0,RD);p(6,0,RD);p(7,0,O3);          // pointed ears
        p(1,1,O2);p(2,1,O1);p(3,1,O3);p(5,1,O3);p(6,1,O1);p(7,1,O2);
        p(2,2,O1);p(3,2,O1);p(4,2,O1);p(5,2,O1);
        p(1,3,O2);p(2,3,O1);p(3,3,B);p(4,3,O2);p(5,3,B);p(6,3,O1);p(7,3,O2); // head+eyes
        p(2,4,O2);p(3,4,C);p(4,4,C);p(5,4,O2);            // cream muzzle
        p(3,5,RD);p(4,5,B);                                // nose
        p(1,5,O2);p(2,5,O1);p(5,5,O1);p(6,5,O2);
        p(1,6,O2);p(2,6,O2);p(3,6,O2);p(4,6,O2);p(5,6,O2);p(6,6,O2);
        p(1,7,O3);p(2,7,O2);p(5,7,O2);p(6,7,O3);
        p(2,8,O3);p(3,8,O3);p(5,8,O3);p(6,8,O3);
        // 6 curly tails (3 visible tufts on right)
        p(8,3,RD);p(9,3,O1);p(9,4,O1);p(8,4,RD);
        p(8,5,O1);p(9,5,RD);p(8,6,RD);p(9,6,O1);
        p(7,4,O1);p(7,5,O2);

      // ── 20. 가디 (Growlithe) ──
      } else if (n === "가디") {
        const [O1,O2,O3,ST,C] = ['#FFC060','#E87020','#A04A10','#4A2000','#FFF8E0'];
        p(2,0,O3);p(3,0,O2);p(5,0,O2);p(6,0,O3);          // ears
        p(2,1,O2);p(3,1,O1);p(5,1,O1);p(6,1,O2);
        p(1,2,ST);p(2,2,O1);p(3,2,O1);p(4,2,O1);p(5,2,O1);p(6,2,O1);p(7,2,ST); // dark stripes head
        p(1,3,O2);p(2,3,O1);p(3,3,B);p(4,3,O2);p(5,3,B);p(6,3,O1);p(7,3,O2); // eyes
        p(2,4,O2);p(3,4,C);p(4,4,C);p(5,4,O2);            // cream muzzle
        p(3,5,B);p(4,5,O2);                                // nose + mouth
        p(0,5,ST);p(1,5,O1);p(2,5,C);p(3,5,C);p(4,5,C);p(5,5,C);p(6,5,O1);p(7,5,ST); // body stripe
        p(0,6,O2);p(1,6,O1);p(2,6,ST);p(3,6,O1);p(4,6,O1);p(5,6,ST);p(6,6,O1);p(7,6,O2);
        p(1,7,O3);p(2,7,O2);p(5,7,O2);p(6,7,O3);
        p(1,8,O2);p(2,8,O3);p(5,8,O3);p(6,8,O2);
        // fluffy cream tail
        p(8,4,C);p(9,4,O1);p(8,5,O1);p(9,5,O2);p(8,3,C);p(9,3,C);
      }
